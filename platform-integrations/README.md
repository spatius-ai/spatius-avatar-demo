...
The same directory lives at [`platform-integrations`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/platform-integrations) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/platform-integrations
```
