...
The same directory lives at [`platform-integrations/livekit-room-demo`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/platform-integrations/livekit-room-demo) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/platform-integrations/livekit-room-demo
```
