        ...
        <div className="config-container">
          ...
          <div className="config-form">
            <div className="field">
              ...
              <input value={appId} onChange={e => setAppId(e.target.value)} placeholder="app_xxx" />
            ...
            <div className="field">
              ...
              <input type="password" value={token} onChange={e => setToken(e.target.value)} placeholder="Your session token" />
              <span className="field-hint">Required for server communication in Direct Mode</span>
            </div>
            <div className="field">
              <label>Region</label>
            ...
            <button className="primary init-btn" disabled={!canInit || loading} onClick={handleInit}>
