...
The same directory lives at [`direct-mode/clients/web/reference/nextjs-iframe`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/direct-mode/clients/web/reference/nextjs-iframe) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/direct-mode/clients/web/reference/nextjs-iframe
```
