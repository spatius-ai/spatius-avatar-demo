...
The same directory lives at [`direct-mode/clients/android`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/direct-mode/clients/android) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/direct-mode/clients/android
```
