...
The same directory lives at [`direct-mode/servers/python`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/direct-mode/servers/python) there.
