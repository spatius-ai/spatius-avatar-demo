...
The same directory lives at [`direct-mode/servers`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/direct-mode/servers) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/direct-mode/servers
```
