...
The same directory lives at [`backend-mode/servers`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/backend-mode/servers) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/backend-mode/servers
```
