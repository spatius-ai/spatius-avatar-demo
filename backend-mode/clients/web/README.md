...
The same directory lives at [`backend-mode/clients/web`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/backend-mode/clients/web) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/backend-mode/clients/web
```
