...
The same directory lives at [`backend-mode/clients`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/backend-mode/clients) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/backend-mode/clients
```
