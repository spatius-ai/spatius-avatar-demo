...
The same directory lives at [`rtc-mode/servers`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/rtc-mode/servers) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/rtc-mode/servers
```
