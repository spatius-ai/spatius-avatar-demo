...
The same directory lives at [`rtc-mode/servers/python`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/rtc-mode/servers/python) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/rtc-mode/servers/python
```
