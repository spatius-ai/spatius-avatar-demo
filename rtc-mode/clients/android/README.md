...
The same directory lives at [`rtc-mode/clients/android`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/rtc-mode/clients/android) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/rtc-mode/clients/android
```
