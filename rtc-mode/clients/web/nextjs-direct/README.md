...
The same directory lives at [`rtc-mode/clients/web/nextjs-direct`](https://github.com/spatius-ai/spatius-integration-demo/tree/main/rtc-mode/clients/web/nextjs-direct) there.

```bash
git clone https://github.com/spatius-ai/spatius-integration-demo.git
cd spatius-integration-demo/rtc-mode/clients/web/nextjs-direct
```
